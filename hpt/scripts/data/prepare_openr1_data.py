...
if __name__ == '__main__':
    ...
    import datasets
    train_dataset = datasets.load_dataset('open-r1/OpenR1-Math-220k', split='train') # 94k
    # breakpoint()
    
    # train_dataset = datasets.load_dataset('open-r1/OpenR1-Math-220k', split='default') # 94k
    # filter the dataset
