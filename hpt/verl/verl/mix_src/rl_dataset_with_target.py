...
class RLHFDatasetWithTarget(RLHFDataset):
    ...
    def __init__(self,
        ...
        super().__init__(config, parquet_files, tokenizer, prompt_key, max_prompt_length, filter_prompts, cache_dir, chat_template_func, return_raw_chat, suffix_prompt, truncation)
